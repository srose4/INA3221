...
while True:
  	...
  	current_mA1 = ina3221.getCurrent_mA(LIPO_BATTERY_CHANNEL, SHUNT_RESISTOR_VALUE)  
  	...
  	current_mA2 = -ina3221.getCurrent_mA(SOLAR_CELL_CHANNEL, SHUNT_RESISTOR_VALUE)
  	...
  	current_mA3 = ina3221.getCurrent_mA(OUTPUT_CHANNEL, SHUNT_RESISTOR_VALUE)
